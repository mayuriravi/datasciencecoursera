...
## plot the graph
plot(as.POSIXct(hhpc1_data$newDT, tz="UCT"), as.numeric(hhpc1_data$Sub_metering_1), type = "l", col="black", xlab="", ylab="Energy sub metering", ylim = c(0.0, 40.0))
lines(as.POSIXct(hhpc1_data$newDT, tz="UCT"), as.numeric(hhpc1_data$Sub_metering_2), type = "l", col="red")
lines(as.POSIXct(hhpc1_data$newDT, tz="UCT"), as.numeric(hhpc1_data$Sub_metering_3), type = "l", col="blue")
